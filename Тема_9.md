...
### Результат.
![Меню](https://github.com/FeugiantMortis/Software-engineering/blob/Тема_9/pic/L5.9.png)
...
class Gardener:
    ...
    def knowledge_base():
        ...
        print('1. Не забывайте регулярно поливать и удобрять растения')
        print('2. Определите правильное расстояние между растениями, чтобы они не мешали друг другу')
...
### Результат.
![Меню](https://github.com/FeugiantMortis/Software-engineering/blob/Тема_9/pic/S1.9.png)

## Выводы
1. `@staticmethod`: В Python для создания статических классов используется команда ```@staticmethod```
...
### Результат.
![Меню](https://github.com/FeugiantMortis/Software-engineering/blob/Тема_9/pic/S2.9.png)

## Выводы
1. `bush = TomatoBush(5) gardener = Gardener('John', bush)`: Мы создаём экземпляры классов, представляющие собой помидорный куст и садовника.
...
### Результат.
![Меню](https://github.com/FeugiantMortis/Software-engineering/blob/Тема_9/pic/S3.9.png)

## Выводы
1.  `gardener.work()`: Метод ```work``` позволяет менять состояние помидор
...
### Результат.
![Меню](https://github.com/FeugiantMortis/Software-engineering/blob/Тема_9/pic/S4.9.png)
...
### Результат.
![Меню](https://github.com/FeugiantMortis/Software-engineering/blob/Тема_9/pic/S5.9.png)

## Выводы
1. `gardener.harvest()`: Метод ```harvest``` позволяет собрать урожай
